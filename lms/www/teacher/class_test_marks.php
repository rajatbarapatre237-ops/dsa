...
$__ct_api = rtrim(dirname(dirname($_SERVER['SCRIPT_NAME'] ?? '')), '/') . '/class_test_api.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Enter Class Test Marks</title>
...
<main id="main" class="main">
  ...
  <section class="section">
    <div class="card mb-3">
      <div class="card-body row g-3 align-items-end">
        ...
        <div class="col-md-4 col-lg-2">
          ...
          <select id="course_id" class="form-select"><option value="">Select course</option></select>
        </div>
        <div class="col-md-4 col-lg-2">
        ...
        <div class="col-md-4 col-lg-2">
          <button type="button" id="btnLoad" class="btn btn-primary w-100">Load students</button>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        <div id="testMeta" class="mb-3"></div>
        <div id="alertBox"></div>
        <form id="marksForm" class="d-none">
        ...
        <p id="hint" class="text-muted">Select session, course, subject, and test. Optionally pick a batch, then load students.</p>
      </div>
    </div>
  </section>
</main>
...
<script>
(function () {
  ClassTestFilters.init({
    api: <?php echo json_encode($__ct_api, JSON_UNESCAPED_SLASHES); ?>,
    mode: 'marks',
