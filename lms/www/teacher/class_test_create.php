  ...
  <section class="section">
    <div class="card">
      <div class="card-body">
        ...
        <p class="text-muted small">You can only create tests for courses and subjects assigned to you.</p>
        <div id="alertBox"></div>
        <form id="ctForm" class="row g-3">
          ...
          <div class="col-12">
            ...
            <a href="class_test_marks.php" class="btn btn-outline-primary">Enter marks</a>
