		...
		<div class="login-header box-shadow">
			...
			>
				...
				<div class="login-menu">
					<ul>
						<li><a href="../index.php">Back to Home</a><Span class="px-4">|</Span><a href="index.php">Login</a></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="col-md-6 col-lg-5">
						<div class="login-box bg-white box-shadow border-radius-10">
							<div class="login-title">
								<h2 class="text-center text-primary">Register To DSA</h2>
							</div>
							<?php 
								if(isset($_GET['msg'])){
							...
							?>
							<form method="POST" action="addregisteration.php">
