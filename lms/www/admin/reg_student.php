      ...
      <section class="section container mt-5">
        <div class="card">
            <div class="card-body">
              ...
              <!-- No Labels Form -->
              <form class="row g-3"  action="reg_student.php" method="POST" enctype="multipart/form-data">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <input type="text" name="aadhar" id="aadhar" class="form-control" placeholder="Aadhar Id" required />
                </div>
                <div class="col-md-6">
