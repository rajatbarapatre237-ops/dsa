  ...
  <main id="main" class="main">
                ...
                <table class="table datatable"  >
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $res['duration']." Months";?></td>
                      <td class="">
                      ...
                      <td>
                          <a href="edit_internships.php?id=<?php echo $res['id'];?>" class="btn btn-success">Edit</a>
                      </td>
                      <td>
                          <a href="delete.php?internship&&id=<?php echo $res['id']?>" class="btn btn-danger">Delete</a>
    ...
    <script>
        async function myfun(id, status){
            fetch(`verify.php?internship&id=${id}&verify=${status}`)
            .then(res => res.text())
