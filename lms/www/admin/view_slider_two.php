...
<head>
  ...
  <title>View Rankers Slider</title>
...
<body>
 ...
 ?><!-- End Sidebar-->
  ...
  <main id="main" class="main">
    <div class="pagetitle">
        <h1>View Rankers Slider</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
            <li class="breadcrumb-item">Front Page Customisation</li>
            <li class="breadcrumb-item active">View Rankers Slider</li>
          </ol>
        </nav>
      </div>
                    ...
                    <table class="table  datatable">
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="delete.php?slidertwo&twoimg_id=<?php echo $res['img_id']?>" class="btn  btn-danger">Delete</a>
                            </td>
