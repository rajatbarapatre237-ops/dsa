<?php 
  ...
  $result = $fun->getAllWorkingInterns();
  if(isset($_GET['id'])){
  ...
  <main id="main" class="main">
                        ...
                        <?php
                                    while ($res = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr >
                                                ...
                                                <td  class="">
                                                    <a href="edit_interns.php?id=<?php echo $res['id'] ?>" class="btn  btn-info">Edit</a>
                                                </td>
                                                
                                                <td>
                                                    <a href="delete.php?interns&&id=<?php echo $res['id']?>" class="btn  btn-danger">Delete</a>
                                                </td>
    ...
    <script>
        async function myfun(id, status){
            fetch(`verify.php?interns&id=${id}&verify=${status}`)
            .then(res => res.text())
