...
if (isset($_POST['btn_upload']))
  {
    ...
    $stmt = $dbc->prepare("INSERT INTO slider_one (img_name, img_type, img_path, img_title) VALUES (:iname, :itype, :ipath, :ititle) ");
    ...
    if ($stmt->execute())
      {
        header('Location: slider_one.php?success=yes&title=' . $filetitle);
      }
    else
      {
        header('Location: slider_one.php?success=no');
      }
  }
?>
...
<head>
  ...
  <title>Ranker Slider Upload</title>
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
        <h1>Ranker Slider Upload</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
            <li class="breadcrumb-item">Front Page Customisation</li>
            <li class="breadcrumb-item active">Ranker Slider Upload</li>
          </ol>
        </nav>
      </div>
